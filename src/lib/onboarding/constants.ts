...
export const ONBOARDING_TOUR_STEPS: OnboardingTourStep[] = [
  {
    ...
    body: "Start with your monthly spending room, upcoming commitments, and priority actions, then scan your financial position.",
  ...
  },
  {
    ...
    body: "Category budgets track focused spending limits, while goals show progress from linked account balances.",
