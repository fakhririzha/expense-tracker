      ...
      <GuidedDashboardTourProvider>
        <div className="min-h-screen bg-background flex font-sans">
          ...
          <div className="flex-1 flex flex-col min-w-0">
            {/* Top Navigation */}
            <header
              data-tour-id={ONBOARDING_TOUR_TARGETS.topNavigation}
              className="sticky top-0 z-50 w-full border-b-4 border-black bg-white"
            >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        data-tour-id={ONBOARDING_TOUR_TARGETS.profileMenuTrigger}
                        variant="outline"
                    ...
                    <DropdownMenuContent className="w-56 neo-border neo-shadow rounded-none" align="end" forceMount>
                      ...
                      <DropdownMenuItem asChild className="focus:bg-accent focus:font-bold focus:shadow-[2px_2px_0_0_#000] focus:translate-x-px focus:translate-y-px transition-all rounded-none my-1">
                        <Link
                          ...
                          data-tour-id={ONBOARDING_TOUR_TARGETS.profileMenuLink}
            ...
            {/* Main Content */}
            <main
              data-tour-id={ONBOARDING_TOUR_TARGETS.dashboardMainContent}
              className="container mx-auto py-6 px-4 flex-1 overflow-x-hidden"
            >
              {children}
            </main>
            <OnboardingBootstrap />
