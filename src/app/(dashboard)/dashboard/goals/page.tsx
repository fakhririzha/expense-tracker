...
/**
 * Savings Goals dashboard: multi-account goals with live balance progress.
 */
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Track progress from the balances of the accounts you link to each goal
          </p>
        </div>
      ...
      {sortedGoals.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground mt-1">
            {filterBy === "all"
              ? "Create your first savings goal and link the accounts that fund it."
              : filterBy === "inProgress"
